...
<body>
<form id="frm" action="http://localhost/spring_mvc/mybatis/day0530/modifyProc.do" method="get">
<label>변경사항 입력</label>
...
<c:choose>
<c:when test="${ updateVO.row_cnt ge 1 }">
	<c:out value="${ updateVO.num }"/>번 님의 정보가 변경 되었습니다.
</c:when>
<c:otherwise>
	<c:out value="${ updateVO.num }"/>번 님의 정보가 변경 되지 않았습니다.
