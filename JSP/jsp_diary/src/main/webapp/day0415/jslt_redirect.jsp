...
<body>
<a href="jslt_redirect.jsp?flag=true">정상요청</a>
<a href="jslt_redirect.jsp?flag=false">비 정상요청</a>
<br/>
...
// 접속자의 ip의 끝 구간이 blockIp와 같다면 경찰청
boolean blockFlag=false;
for(int i = 0; i < blockIP.length;i++){
	if(blockIP[i].equals(ip)){
		blockFlag=true;
	}// end if
} // end for

pageContext.setAttribute("block", blockFlag);
%>
<c:if test="${block }">
<c:redirect url="https://www.police.go.kr/index.do"/>
</c:if>
