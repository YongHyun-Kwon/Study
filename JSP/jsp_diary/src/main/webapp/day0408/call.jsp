...
$(function() {
	...
	$("#btnGet").click(function() {
		// JS의 document를 사용한 submit
		document.getFrm.submit();
	}) // click
	$("#btnPost").click(function() {
		// jQuery의 document를 사용한 submit
		$("#postFrm").submit();
	}) // click
}); // ready
</script>
...
<ul>
	...
	<li>
		<form action="call2.jsp" method="get">
			<input type="submit" value="get요청" class="btn btn-primary"/>
		</form>
	</li>
	<li>
		<form action="call2.jsp" method="post">
			<input type="submit" value="post 요청" class="btn btn-danger"/>
		</form>
	</li>
</ul>
</div>
...
<ul>
	...
	<li>
		<form action="call2.jsp" method="post" name="postFrm" id="postFrm">
			<input type="hidden" name="data" value="back-end에 전달할 데이터"/>
			<input type="button" value="JS post 요청" class="btn btn-danger" id="btnPost"/>
		</form>
	</li>
</ul>
</div>
