...
<body>
<form name="frm" action="http://localhost/jsp_prj/day0408/get_parameter_process.jsp" method="get">
<div>
...
<input type="checkbox" name="flag" value="flag value">선택

<input type="button" id="btn" value="전송" onclick="requestJsp()" class="btn btn-success"/>
</div>
<div>
</div>
</form>
<hr/>
<form name="postFrm" action="http://localhost/jsp_prj/day0408/get_parameter_process.jsp" method="post">
<div>
<strong>HTML Form Control 값 받기</strong><br/>
<label>text</label> <input type="text" name="text" class="inputBox"/><br/>
<label>password</label> <input type="password" name="password" class="inputBox"/><br/>
...
<input type="button" id="btn" value="전송" onclick="requestPostJsp()" class="btn btn-success"/>
</div>
<div>
</div>
</form>
