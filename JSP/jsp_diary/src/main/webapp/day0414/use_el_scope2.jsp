...
request.setAttribute("req","리퀘스트"); // forward로 이동된 페이지에서 사용
session.setAttribute("ses","세션"); // 모든 페이지에서 접속자 별로 사용
application.setAttribute("app","애플리케이션"); // 모든 페이지에서 모든 접속자가 사용.
%>
